...
public class HireGui extends Frame implements ActionListener {
	  ...
	  //private String lbl2 = "Ought";
	   ...
	   public HireGui () {
	      ...
	      addapp.addActionListener(new ActionListener() {
	    	    public void actionPerformed(ActionEvent e)
	    	    {
	    	        ...
	    	        apps.add(new applicant(id, resu, interv));
	   ...
	   HashMap<String, double[]> resu = new HashMap<String,double[]>();
	   ...
	   public void actionPerformed(ActionEvent evt) {
		   String[] resms = new String[apps.size()];
		   String[] nams = new String[apps.size()];
		   int i = 0;
		   for(applicant app : apps){
			   resms[i] = app.getResume();
			   System.out.println(resms[i]);
			   nams[i] = String.valueOf(app.getId());
			   System.out.println(nams[i]);
			   i++;
		   }
		   results = applicant.MatCreat(resms,nams);
		   graphy.graphis(results);
		   graphy.main(new String[] {});
		   }
